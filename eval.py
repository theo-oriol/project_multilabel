...
def parse_opt():
    ...
    parser.add_argument("--path_source_split","-pss", type=str, default="/home/oriol@newcefe.newage.fr/Models/project_multilabel/saved_mult_split_limit:None.pkl", help="path to split file")
